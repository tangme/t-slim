...
function minjs ({ curdir = true, cover = false }) {
  let dir = curdir ? ["*.js", "!*.min.js"] : ["./**/*.js", "!./**/*.min.js"];
    ...
    return gulp.src(dir) 
        .pipe(babel({
            presets: [['@babel/env',{modules: false}]],//modules:false   去除 use strict Babel code adds use strict automatically because es2015 by default expects code to be ES6 modules, which are strict by default.
        }))
